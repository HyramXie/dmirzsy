...
if __name__ == "__main__":
    # 请替换为实际文件路径
    jsonl_file = "/root/user/LLaMA-Factory/eval_62/qwen2.5vl-7b/7b_17_l.jsonl"  # 数据集1文件
    json_file = "/root/user/datasets/twitter2017/test+image_context.json"    # 数据集2文件
    output_file = "/root/user/LLaMA-Factory/eval_train/merged_dataset_sc_new_17.json"  # 输出文件
