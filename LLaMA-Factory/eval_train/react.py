...
# 初始化 DeepSeek API
client = OpenAI(
    api_key="sk-50ed7637d89e43be9f33ef9ccaee461f",
    base_url="https://dashscope.aliyuncs.com/compatible-mode/v1"  # 或你的代理地址
)

input_file = "/root/user/LLaMA-Factory/eval_train/llava1.5-7b/inconsistent_predictions_17.jsonl"
output_file = "/root/user/LLaMA-Factory/eval_train/llava1.5-7b/17_explain.jsonl"
