...
def vllm_infer(
    ...
    dataset: str = "mvsa_test",
    dataset_dir: str = "data",
    template: str = "qwen2_vl",
    cutoff_len: int = 4096,
    max_samples: Optional[int] = None,
    vllm_config: str = "{}",
    save_name: str = "eval_62/qwen2.5vl-3b/mvsa_sc_2.jsonl",
    ...
    Usage: CUDA_VISIBLE_DEVICES=1 python 62/vllm_infer62.py --model_name_or_path output_62/qwen2.5_vl-3b/lora/sft_mvsa
    """
