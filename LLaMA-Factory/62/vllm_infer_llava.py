...
def vllm_infer(
    ...
    dataset: str = "mllm_demo",
    dataset_dir: str = "data/2017",
    template: str = "llava",    #qwen2_vl
    cutoff_len: int = 4096,
    max_samples: Optional[int] = None,
    vllm_config: str = "{}",
    save_name: str = "eval_62/llava1.5-7b/t+i_17.jsonl",
    ...
    Usage: CUDA_VISIBLE_DEVICES=0 python 62/vllm_infer62.py --model_name_or_path output_62/llava1_5-7b/lora/sft_17_t+i
    """
    ...
    if template_obj.mm_plugin.__class__.__name__ != "BasePlugin":
        engine_args["limit_mm_per_prompt"] = {"image": 1, "video": 2, "audio": 2}
