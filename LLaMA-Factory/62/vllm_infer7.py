...
def vllm_infer(
    ...
    vllm_config: str = '',
    save_name: str ="eval_62/qwen2.5vl-7b/mvsa_sc.jsonl",
    ...
    Usage: CUDA_VISIBLE_DEVICES=1 python 62/vllm_infer7.py --model_name_or_path output_62/qwen2.5_vl-7b/lora/sft_mvsa_sc
    """
    ...
    engine_args = {
        ...
        "dtype": "bfloat16",
        "max_num_seqs": 32,
        "gpu_memory_utilization": 0.85,  # 控制显存使用率
