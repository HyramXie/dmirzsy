...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="output_62/qwen2.5_vl-3b/lora/sft_mvsa")
    parser.add_argument("--adapter_path", type=str, default=None)
    parser.add_argument("--dataset", type=str, default="nvsa_test")
    ...
    parser.add_argument("--save_dir", type=str, default=os.path.join(os.path.dirname(__file__), "..", "eval_62", "qwen2.5vl-3b"))
    parser.add_argument("--prefix", type=str, default="mvsa_test")
