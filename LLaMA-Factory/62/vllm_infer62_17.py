...
def vllm_infer(
    ...
    vllm_config: str = "{}",
    save_name: str = "eval_62/qwen3vl-4b_nothink/sc_17_3.jsonl",
    ...
    Usage: CUDA_VISIBLE_DEVICES=0 python 62/vllm_infer62_17.py --model_name_or_path output_62/qwen3_vl-4b_nothink/lora/sft_17_sc
    """
